...
const RegexBuilder_1 = require("./Tokenizer/RegexBuilder");
const Symbols_1 = require("./Tokenizer/Symbols");
const ws = /\s/g;
// Regex that matches if an entire line is only comprised of whitespace and punctuation
const puncEscaped = RegexBuilder_1.escapeRegExp(Symbols_1.ALL_PUNC).replace(/\n/, "\\n");
 ...
 */
function minimize(text, delim, maxSize) {
